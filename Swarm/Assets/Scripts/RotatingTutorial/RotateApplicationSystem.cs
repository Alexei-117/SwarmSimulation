...
{ 
    ...
    public class RotateApplicationSystem : JobComponentSystem
    {
        ...
        private struct ApplicationJob : ITriggerEventsJob
        {
            ...
            {
                // [TOEXPLAIN] This is some tutorial bullshit that can be handled far better
        ...
        protected override JobHandle OnUpdate(JobHandle inputDeps)
        {
            ...
            // [TOEXPLAIN] What is the Step physics world? what does it do? Same with the Build Physics world. And
